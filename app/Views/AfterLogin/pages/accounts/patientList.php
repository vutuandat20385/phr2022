<div class="card p-3">
    <div class="row m-0">
        ...
        <div class="col-md-1 p-1">
            <select class="form-control form-control-lg" name="" id="sltCity">
                <option class="p-2" value="">Tỉnh/TP</option>
                <?php foreach($city_village_list as $k => $c){ ?>
                    <option class="p-2" value="<?= $c['city_village']; ?>"><?= $c['city_village']; ?></option>
                <?php } ?>
                
            </select>
        </div>
        <div class="col-md-1 p-1">
            <select class="form-control form-control-lg" name="" id="sltCode">
                <option class="p-2" value="">Mã GT</option>
                <?php foreach($referralCode as $k => $rc){ ?>
                    <option class="p-2" value="<?= $rc['referral_code']; ?>"><?= $rc['referral_code']; ?></option>
                <?php } ?>
