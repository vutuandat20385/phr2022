        ...
        <div class="card" style="margin-top:0 !important;">
            <div class="row card-header" style="padding-bottom: 0;">
                <div class="col-10 text-center">
                    <ul class="nav nav-pills nav-pills-warning" role="tablist">
                        <li class="nav-item"> <a class="nav-link active " href="<?= base_url(); ?>/trang-quan-tri/tu-van-qua-app/lich-tai-kham"> DS lịch tái khám </a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url(); ?>/trang-quan-tri/tu-van-qua-app/lich-tai-kham-qua-hen"> Lịch tái khám quá hẹn </a> </li>
                    </ul>
                </div>  
                <div class="col-2">
                ...
                <div class="col-2">
                    <select class="form-control" name="" id="sltStatus">
                        <option class="p-2" value="Sắp đến hẹn">Sắp đến hẹn</option>
                        <option class="p-2" value="Đến hẹn">Đến hẹn</option>
                        <option class="p-2" value="Đã liên lạc">Đã liên lạc</option>
                    </select>
                </div>
            ...
            <div class="card-body" style="padding-top: 0;">
                <div class="tab-content tab-space">
                    <div class="tab-pane active" id="appListOver" >
                        <?php if($appointmentFollowList){?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 div-phantrang">
                                    <?php if ($pager):?>
                                        <?php $pagi_path = 'trang-quan-tri/tu-van-qua-app/lich-tai-kham'; ?>
...
<script>
    ...
    $(document).ready(function(){
        $('#btn_timkiem').click(function(){
            ...
            var link = '<?php echo base_url(); ?>' + '/trang-quan-tri/tu-van-qua-app/lich-tai-kham?page=1';
