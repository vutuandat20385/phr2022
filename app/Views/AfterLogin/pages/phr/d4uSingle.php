<div class="card p-3">
                ...
                <?php if($posts){?>
                    <?php foreach($posts as $user){ ?>
                        <tr>
                            ...
                            <td><?php if($user['birthdate'] != '' && $user['birthdate'] != '0000-00-00'){
                        ...
                        <!-- /.modal -->
                        <div class="modal fade" id="modal-lg<?= $user['annual_checkup_id'] ?>">
    ...
    <div class="col-md-6 div-phantrang">
        <?php if ($pager):?>
            <?php $pagi_path = 'trang-quan-tri/benh-an/d4u-khach-le'; ?>
...
$(document).ready(function(){
        $('#btn_timkiem').click(function(){
            ...
            var link = '<?php echo base_url(); ?>' + '/trang-quan-tri/benh-an/d4u-khach-le?page=1';
